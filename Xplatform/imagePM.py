...
#        lbl4.configure(text = "Opps! No metadata found ", fg = "red")
    ...
    try:
        ...
        b = int(x[1])
        c = int(x[2])
        deg_symbol = "\N{DEGREE SIGN}"
        degree0 = str(a)+ deg_symbol
        minute0 = str(b)+"'"
        second0 = str(c)+'"'
        gps_info0 = degree0 + minute0 + second0
        entry3.insert(10, gps_info0)
    except (KeyError,AttributeError):
    ...
    try:
        ...
        m = int(y[1])
        n = int(y[2])
        degree1 = str(l)+ deg_symbol
        minute1 = str(m)+ "'"
        second1 = str(n)+ '"'
        gps_info1 = degree1 + minute1 + second1
        entry5.insert(10, gps_info1)
    except (KeyError,AttributeError):
...
window.title("imagePM | Author::Shams Parvez Arka")
...
#r2c1
entry0 = Entry(window, text = "", width = 13)
...
#r3c1
entry2 = Entry(window, text = "", width = 13)
entry2.grid(row = 3, column = 1)
#r3c3
lbl8 = Label(window, text = "Latitude", width = 10)
...
#r4c1
entry4 = Entry(window, text = "", width = 13)
